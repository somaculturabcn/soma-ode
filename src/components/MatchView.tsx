...
// Lista em cards + filtros + criar/editar + CSV + Scout por URL
...
export default function MatchView() {
  ...
  }, [allOpportunities, search, typeFilter, countryFilter, onlyCosts])
  ...
  return (
    <div style={styles.wrap}>
      <header style={styles.header}>
        <div>
          ...
          <p style={styles.subtitle}>
            {filtered.length} de {allOpportunities.length} oportunidades · cards com edição, CSV e Scout por URL
          </p>
        </div>
      ...
      <section style={styles.toolbar}>
        <input
          style={styles.input}
          placeholder="Pesquisar por título, país, disciplina, keyword..."
          value={search}
